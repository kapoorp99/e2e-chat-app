...
export default function Conversation({ receiver, user }) {
  ...
  const setSecretKey = async () => {
    ...
    const pubkeyRef = doc(db, "users", user.uid); //Getting the sender's private and public key from the  collection in firebase
    ...
    const privkeyRef = doc(db, "users", receiver.uid);  ////Getting the receiver's public key from the  collection in firebase
    ...
    <div className="chatscreen">
      ...
      {receiver ? (
        <div className="encryption-details">
          <button className="chev-button" onClick={(e) => handleClick(e)}>Show Encryption </button>
